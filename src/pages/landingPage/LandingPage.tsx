    ...
    return (
        <span className='landingPage'>
            <span className='landingPage__container'>
                ...
                <p>- Or, I would really appriciate if you can support this humanitarian cause.</p>
                <div className='landingPage__container__buttons'><Button text='Get Started' onClick={() => handleGetStarted()} /></div>
            </span>
        </span>
    );
};
