    ...
    return (
        <span className='landingPage'>
            <span className='landingPage__container'>
                ...
                <div className='landingPage__container__links'><p><a href='https://github.com/ltemihai/monthly-planner' target='_blank'>Github</a></p> <p><a href='https://github.com/ltemihai/monthly-planner/wiki' target='_blank'>Docs</a></p> <p><a href='/' target='_blank'>Buy me a coffe</a></p></div>
